          ...
          <div className="footer-column footer-brand">
            <div className="footer-logo">
              <svg width="100" height="50" viewBox="0 0 100 50" xmlns="http://www.w3.org/2000/svg">
                <ellipse cx="18" cy="12" rx="23" ry="7.5" fill="#1E3A8A" transform="rotate(-25 18 12)"/>
                <ellipse cx="21" cy="25" rx="25" ry="8.5" fill="#2563EB" transform="rotate(5 21 25)"/>
                <circle cx="18" cy="39" r="8.5" fill="#0EA5E9"/>
